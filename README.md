...
Repository → **Settings** → **Pages** → unter *Source* den Branch `main` und den Ordner `/ (root)` wählen. Nach wenigen Minuten ist die Seite unter `https://pee111.github.io/psychoonkologie-blog/` erreichbar. Eine eigene Domain lässt sich dort ebenfalls hinterlegen.
